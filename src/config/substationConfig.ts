...
/**
 * ============================================================================
 * CONFIGURACIÓN Y CONSTANTES DE LA SUBESTACIÓN ELÉCTRICA (SECTOR NORTE)
 * ============================================================================
 * Coordenadas espaciales y catálogo de assets para la zona de materiales galvánicos (140..260m X, 280..400m Z).
 */

export const SUBSTATION_CONFIG = {
  bounds: {
    minX: 140,
    maxX: 260,
    minZ: 280,
  ...
  // Hitos principales
  galvanicCenter: {
    center: Vector3.create(200, 0.05, 340),
    name: 'Plataforma Central de Transformadores Galvánicos'
  },
  alchemicalBatteries: {
    center: Vector3.create(170, 0.05, 320),
    name: 'Banco de Baterías Alquímicas'
  },
  steamEnginesStation: {
    center: Vector3.create(230, 0.05, 360),
    name: 'Estación de Motores de Vapor'
  },
